          ...
          children: [
            ...
            ElevatedButton(
                style: ButtonStyle(
                  ...
                  shape: WidgetStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(80.0))),
                ),
                onPressed: () async {
                ...
                child: Ink(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: <Color>[HexColor("#D25B79"), HexColor("#ff7295")],
                    ),
            ...
            ElevatedButton(
                ...
                child: Ink(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: <Color>[HexColor("#834BD0"), HexColor("#9d57ff")],
                    ),
                    borderRadius: const BorderRadius.all(Radius.circular(80.0)),
                  ),
                  child: Padding(
