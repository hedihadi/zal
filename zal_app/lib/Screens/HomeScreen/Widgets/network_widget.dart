                      ...
                      Table(
                        ...
                        children: <TableRow>[
                          tableRow(
                            ...
                            "",
                            FontAwesomeIcons.cloudArrowUp,
                            "${data.networkInterfaces.firstWhereOrNull((element) => element.isPrimary == true)?.bytesSent.toSize(decimals: 1)}",
                          ),
                          tableRow(
                            context,
                            "",
                            FontAwesomeIcons.cloudArrowDown,
                            "${data.networkInterfaces.firstWhereOrNull((element) => element.isPrimary == true)?.bytesReceived.toSize(decimals: 1)}",
                          ),
                        ],
                      ),
                    ],
